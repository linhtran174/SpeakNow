...
sudo iptables -t nat -A PREROUTING -p tcp -m tcp --dport 9000 -m statistic --mode nth --every 4 --packet 0 -j REDIRECT --to-ports 9001
sudo iptables -t nat -A PREROUTING -p tcp -m tcp --dport 9000 -m statistic --mode nth --every 3 --packet 0 -j REDIRECT --to-ports 3002
sudo iptables -t nat -A PREROUTING -p tcp -m tcp --dport 9000 -m statistic --mode nth --every 2 --packet 0 -j REDIRECT --to-ports 3003
sudo iptables -t nat -A PREROUTING -p tcp -m tcp --dport 9000 -j REDIRECT --to-ports 3004
